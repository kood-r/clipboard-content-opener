...
$(document).on("click", ".save-button", function () {
  ...
  const openFirstPageForeground = $("#open-first-page-foreground").prop(
    "checked"
  );
  const parseLineByLine_shiftAlt = $("#parse-line-by-line-shift-alt").prop(
    "checked"
  );
...
function copyElements() {
  ...
  // ページの開き方
  $(".replace_page-open-tab-wrapper").replaceWith(
    $(".page-open-tab-wrapper").clone()
  );
}
